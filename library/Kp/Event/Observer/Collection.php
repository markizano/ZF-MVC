 ...
 */
// TODO: Re-work Event and Observers
class Kp_Event_Observer_Collection
{
    /**
     * Array of observers
     *
     ...
     */
    public function addObserver(Kp_Event_Observer $observer)
    {
     ...
     * @return Varien_Event_Observer_Collection
     */
    public function dispatch(Kp_Event $event)
    {
