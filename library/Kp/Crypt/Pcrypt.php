...
define("MODE_ECB",0);
define("MODE_CBC",1);
//require_once INCLICK_CLASSES_DIR . "/utility/encryption/BlowfishCipher.php";
...
class Kp_Crypt_Pcrypt
{
    ...
    public function __construct($blockmode = MODE_ECB, $cipher = 'Blowfish', $key = null)
    {
        // Load cipher_class
        if (!class_exists("Kp_Crypt_Pcrypt_".$cipher))
        {
            $this->error("Class Kp_Crypt_Pcrypt_".$cipher." doesn't exists");
        }

        $class  = "Kp_Crypt_Pcrypt_".$cipher;
    ...
    /** Method to encrypt using ECB mode.
      ...
      * @return string $cipher the plain text encrypted
      */
    protected function _ecb_encrypt($plain)
    {
    ...
    /** Method to decrypt using ECB mode.
      ...
      * @return string $plain  the cipher text decrypted
      */
    protected function _ecb_decrypt($cipher)
    {
        $blocksize  = $this->cipher->blocksize;
    ...
    /** This method encrypt using CBC mode.
      ...
      * @return string $cipher the plain text encrypted
      */
    protected function _cbc_encrypt($plain)
    {
        $blocksize = $this->cipher->blocksize;
        $plainsize = strlen($plain);
        $cipher    = '';
    ...
    /** This method decrypt using CBC.
      ...
      * @return string $plain  the cipher text decrypted
      */
    protected function _cbc_decrypt($cipher)
    {
