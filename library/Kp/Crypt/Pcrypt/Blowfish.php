...
class Kp_Crypt_Pcrypt_Blowfish
{
    ...
    /** This functions encrypt the block.
      ...
      * @return void
      */
    protected function _blowfish_crypt(&$Xl, &$Xr)
    {
        for($i = 0; $i < 16; $i++)
        {
            $Xl = $Xl ^ $this->bctx['p'][$i];
    ...
    /** This method decrypt the block.
      ...
      * @return void
      */
    protected function _blowfish_decrypt(&$Xl, &$Xr)
    {
        for($i = 17; $i >= 2 ; $i--)
        {
            $Xl = $Xl ^ $this->bctx['p'][$i];
    ...
    /** This method is called by pcrypt class.
      ...
      */
    protected function _encrypt($block)
    {
    ...
    /** This method is called by pcrypt class.
      ...
      */
    protected function _decrypt($block)
    {
        // unpack the block in unsigned long ints (uInt32)
        $data = array_values(unpack('N*', $block));
