...
/**
 * Base class providing XML accessing and parsing functionality.
 *
 * @category   Zend
 * @package    Zend_Service
 * @subpackage AuthorizeNet
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Kp_Plugins_Authorizenet_Response {
    /**
     * Schema namespace
     */
    protected $_xmlNamespace = null;
    ...
    /**
     * Creates a new AuthorizeNet response object
     *
    ...
    public function getXPath()
    {
        if ($this->_xpath === null) {
            ...
            if ($document === false) {
                ...
                $this->_xpath->registerNamespace('anet', $this->getNamespace());
            }
        }
