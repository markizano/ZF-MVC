 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Kp_Plugins_Authorizenet_Cim_Data_Xml_PaymentBankAccount extends Kp_Plugins_Authorizenet_Cim_Data_PaymentBankAccount
{
    /**
    ...
    {
        return $this->getTagValue('bankAccount', parent::toString($indent + 1), $indent, true);
    }
}
