 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Kp_Plugins_Authorizenet_Cim_Data_Xml_PaymentCreditCard extends Kp_Plugins_Authorizenet_Cim_Data_PaymentCreditCard
{
    /**
    ...
    {
        return $this->getTagValue('creditCard', parent::toString($indent + 1), $indent, true);
    }
}
